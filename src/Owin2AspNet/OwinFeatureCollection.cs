...
namespace Owin2AspNet
{
    ...
    public class OwinFeatureCollection : IFeatureCollection,
        IHttpRequestFeature,
        ...
        IHttpWebSocketFeature
    {
        ...
        private void Prop(string key, object value)
        {
        ...
        {
            get { return OwinHelper.AddQuestionMark(Prop<string>(OwinConstants.RequestQueryString)); }
            set { Prop(OwinConstants.RequestQueryString, OwinHelper.RemoveQuestionMark(value)); }
        }

        IHeaderDictionary IHttpRequestFeature.Headers
        {
            get { return OwinHelper.MakeHeaderDictionary(Prop<IDictionary<string, string[]>>(OwinConstants.RequestHeaders)); }
            set { Prop(OwinConstants.RequestHeaders, OwinHelper.MakeDictionaryStringArray(value)); }
        }
        ...
        {
            get { return OwinHelper.MakeHeaderDictionary(Prop<IDictionary<string, string[]>>(OwinConstants.ResponseHeaders)); }
            set { Prop(OwinConstants.ResponseHeaders, OwinHelper.MakeDictionaryStringArray(value)); }
        }
        ...
        ClaimsPrincipal IHttpAuthenticationFeature.User
        {
            get
            {
                return Prop<ClaimsPrincipal>(OwinConstants.RequestUser)
                    ?? OwinHelper.MakeClaimsPrincipal(Prop<IPrincipal>(OwinConstants.Security.User));
            }
            set
            {
